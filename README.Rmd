...
* Use keys '1' to '8' to toggle that pattern as active.  This will let you compose
  longer rhythms by chaining together multiple patterns.
...
Press `t` (for twitter) within the application to print a text representation to 
your R console.
